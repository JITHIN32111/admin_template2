        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center">
            ...
            <Link
              ...
              className="ml-3 p-2 rounded-full bg-gradient-to-r from-purple-950 via-purple-900 to-purple-800 text-white"
            >
              <IconPencilPaper />
            </Link>
          </div>
          ...
          {userInfo && userInfo.isAdmin && (
            <div className="flex flex-col gap-6 flex-1">
              <div className="flex flex-row gap-2 sm:gap-6">
                <DashboardCard
                  title="Earning"
                  value={totalAmountInfo && totalAmountInfo?.earningSum}
                ...
                <DashboardCard
                  title="Autopool"
                  value={totalAmountInfo && totalAmountInfo?.totalAutoPoolBank}
              ...
              <div className="flex flex-row gap-2 sm:gap-6">
                <DashboardCard
                  title="Profit"
                  value={userInfo && userInfo?.companyProfit}
                ...
                <DashboardCard
                  title="Withdrawal"
                  value={totalAmountInfo && totalAmountInfo?.savingSum}
          ...
          <div className="bg-gray-50 text-gray-800 rounded-lg shadow-lg p-6 space-y-6 w-full h-full hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="flex-1 w-full space-y-4">
              <div className=" p-4 rounded-lg">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-md font-semibold text-gray-600">
                      User ID:{userInfo && userInfo.ownSponserId}
                    </h3>
                    <p className="text-lg text-gray-800">DM155465</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    {/* <p className="text-lg text-green-500">Activated</p> */}
                    {userInfo && userInfo.userStatus === true ? (
                  ...
                  <div>
                    ...
                    {/* <p className="text-lg text-red-500">Not Activated</p> */}
                    {userInfo && userInfo.autoPool == false ? (
                  ...
                  <div className="text-center mt-5">
                    {userInfo &&
                      userInfo.joiningRequest &&
                      userInfo.joiningRequest.status == false && (
                        <>
                          You are successfully sent your join request. You will
                          be verified soon.
                        </>
                      )}
                    {userInfo &&
                      userInfo.joiningRequest &&
                      userInfo.joiningRequest.status == true && (
                        <>You are verified.</>
                      )}
                  </div>
                </div>
            ...
            {userInfo && userInfo.userStatus && (
              <div className="flex items-center space-x-2 bg-gray-100 p-3 rounded-lg w-full">
                ...
                <div className="flex items-center space-x-2">
                  <p className="text-lg font-semibold text-gray-800">{url}</p>
                  <FaCopy className="h-5 w-5 text-gray-600 cursor-pointer hover:text-indigo-500 transition-colors" />
                </div>
              </div>
            )}
